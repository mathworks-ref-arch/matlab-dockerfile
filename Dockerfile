...
# is the preferred option. You can either use a build variable, like this: --build-arg LICENSE_SERVER=27000@MyServerName; 
# or you can specify the license server directly using: ENV MLM_LICENSE_FILE=27000@flexlm-server-name
ENV MLM_LICENSE_FILE=$LICENSE_SERVER

# Option 2:
# Alternatively, you can put a license file in the container.
# Fill this file out with the details of the license 
